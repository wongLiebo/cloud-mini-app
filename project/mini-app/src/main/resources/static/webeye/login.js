...
/*function hiddenPass(e){
	...
	var pdmd5 =document.getElementById("loginPass");
	...
	if(kcode!=8 && kcode!=118){
		...
		j_pass.value=j_pass.value.substring(0,pdmd5.length);
	}
}
*/
function login() {
    ...
    var pword = $.common.trim($("input[name='password']").val());
    ...
    // aes加密
    var pdmd5 = Encrypt(pword,randomStr);
    // rsa加密
