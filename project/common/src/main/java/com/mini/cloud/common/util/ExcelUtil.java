...
import com.mini.cloud.common.auth.annotation.Excels;
import com.mini.cloud.common.bean.AjaxResult;
import com.mini.cloud.common.bean.BaseResult;
import com.mini.cloud.common.config.WebEyeConfig;
import com.mini.cloud.common.exception.BusinessException;
import com.mini.cloud.common.util.reflect.ReflectUtils;
...
//    }
    ...
    {
        String downloadPath = WebEyeConfig.getDownloadPath() + filename;
//        String downloadPath = "D:/download/" + filename;
        log.info("==================================下载文件名及路径===========================：{}",downloadPath);
